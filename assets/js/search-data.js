...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Selected publications and research outputs in medical imaging AI, cardiac MRI analysis, computer vision, and applied machine learning.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Applied AI researcher and data scientist specialising in computer vision, medical imaging AI, and reproducible machine learning pipelines for biomedical data.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/HenryOn_DataScientist_CV_v2.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%65%6E%72%79%6F%6E%31%31%33%30@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/HenryOn2021", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/henryon1993", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=2SIGfakAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
