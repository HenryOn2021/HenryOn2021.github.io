...
title: about
permalink: /
subtitle: Medical Imaging AI | Computer Vision | Applied Machine Learning | Data Science
...
profile:
  ...
  more_info: >
    ...
    <p>Open to industry and research opportunities</p>
...
- Cardiac MRI segmentation and disease classification
- Self-supervised and transfer learning for limited-labelled-data settings
- Multi-view representation learning for cine MRI
...
- Medical image preprocessing, training, inference, and evaluation
- Segmentation and classification model development
- Structured experiment design and reproducible reporting
- Cross-disciplinary communication with clinical and technical stakeholders
